package com.brandonmott.patterns.ch3.unification
...
/*
  ...
  This adds a high level of flexibility in the language and makes modeling easier than in other functional programming languages.
 */
