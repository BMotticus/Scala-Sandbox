package com.brandonmott.fpInScala.ch4.errors
...
/**
  ...
  *
  * See if you can recognize the com.brandonmott.patterns these functions encapsulate before you resort to pattern matching.
  */
