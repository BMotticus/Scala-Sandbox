...
import Stream._
  ...
  /** <b>An Important Note:</b> A major theme of functional programming is "separation on concerns", separate descriptions of computations from actually running them.
...
object Stream {
  ...
  /** The function `unfold` is a very general Stream-building function. 
    ...
    * 
    * <b>Corecursion is also sometimes called `guarded recursion`, and Productivity is also sometimes called cotermination.</b>
    *
