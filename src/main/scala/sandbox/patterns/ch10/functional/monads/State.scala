package sandbox.patterns.ch10.functional.monads
...
/**
  * FileIO hides the state by creating a private class that nobody can instantiate 
  */
...
import sandbox.patterns.ch10.functional.monads
